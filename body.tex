...
\epsscale{1}
\caption{The total amout of possible time per night and the average amount of time after removing weather downtime. Shaded regions show scheduled downtime. Our modeled uncheduled downtime is not included in the plot.}
\end{figure}
